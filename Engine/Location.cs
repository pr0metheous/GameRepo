...
namespace Engine
{
    public class Location
    {
        ...
        public Location(int id, string name, int locId, string description, Item itemRequiredToEnter = null, Quest questAvailableHere = null, Monster monsterLivingHere = null)
        {
            this.LocId = locId;
            this.ID = id;
            this.Name = name;
