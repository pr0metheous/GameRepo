...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateLocations()
        {
            ...
            Location home = new Location(LOCATION_ID_HOME, "Home",0, "Your Gaff.. Look at the state of the place.. bout time you got out of here and made a few quid for yourself\nMon we go make a few quid!!");

            Location townSquare = new Location(LOCATION_ID_TOWN_SQUARE, "Moyross - Glenagh", 1,"You see a couple of burnt out cars, and two young fellas walking through them,, they pull something from under the brolly and stick it under the car,, do you want to go and see what they hid??");

            Location burnedCar = new Location(LOCATION_ID_BURNED_CAR, "Burnt out Car", 6, "You decide to take a chance and sneak up to the car to see what was hid,, You found a dirty old sawn off. It will do the job for now I suppose");


            Location alchemistHut = new Location(LOCATION_ID_ALCHEMIST_HUT, "Alchemist's hut", 2,"There are many strange plants on the shelves.");
            ...
            burnedCar.LocationToSouth = townSquare;
            ...
            Locations.Add(estate);
            Locations.Add(spiderField);
            Locations.Add(burnedCar);
        }
